...
typedef int	( *PFI_i)(int*);
typedef int	( *PFI_v)(const void*);
typedef int	( *PFI_v_v)(const void*, const void*);
typedef void( *PFV_v_c)(const void*, char*);
typedef int	( *PFIv)(void);
typedef HDL	( *PFHi_v)(int,void*);
typedef void( *PFVh)(HDL);
typedef void( *PFVv)(void);
typedef void( *PFV_v)(void*);
typedef int	( *PFIi_v)(int,void*);
typedef HDL	( *PFIh_v)(HDL,void*);
...
int  cp_short2(const void *a, const void *b);
...
int  cp_ulong2(const void *a, const void *b);
int  cp_ulongt4(const void *a, const void *b);
...
int		cp_ulong_v(uint32_t a, uint32_t b);
#endif
